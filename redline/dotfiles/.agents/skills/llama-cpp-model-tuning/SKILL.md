...
| llama.cpp flake pin | `~/nixos-configuration/common-ai/llama-flake/flake.nix` |
| llama.cpp source checkout | `~/programming/llama.cpp` |
| ik_llama.cpp flake pin | `~/nixos-configuration/common-ai/ik-llama-flake/flake.nix` |
...
REV=$(grep -oP 'llama.cpp/\K[0-9a-f]{40}' ~/nixos-configuration/common-ai/llama-flake/flake.nix)

...
- Keep titles concise and specific, and prefer one clause over more: name the component and the symptom in a single phrase (e.g. "Login form ignores submit on second click" not "login bug"). If you can't express it in one clause, the issue may be too broad — consider splitting.
